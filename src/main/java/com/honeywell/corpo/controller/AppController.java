...
import com.honeywell.corpo.service.EmployeeService;
...
public class AppController {
	...
	public String editEmployee(@PathVariable String ssn, ModelMap model){
		Employee emp = empService.findEmployeeBySsn(ssn);
	...
	public String updateEmployee(@Valid Employee employee, BindingResult result, ModelMap model, @PathVariable String ssn){
		...
		model.addAttribute("sucess", "Employee " + employee.getfName() + " update successfully");
